...
if($PostSql = $mysqli->query("SELECT * FROM business LEFT JOIN categories ON categories.cat_id=business.cid WHERE business.active=1 AND categories.cat_id='$id' ORDER BY business.biz_id DESC LIMIT $start, 12")){
