...
<div class="page-title"><h1>Popular Businesses</h1></div>
...
if($PostSql = $mysqli->query("SELECT * FROM business LEFT JOIN categories ON categories.cat_id=business.cid WHERE business.active=1 ORDER BY business.star5 DESC LIMIT 0, 12")){
...
<nav id="page-nav"><a href="data_popular.php?page=2"></a></nav>
