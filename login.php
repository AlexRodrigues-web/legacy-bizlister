...
<input type="password" class="form-control" name="inputPassword" id="inputPassword" placeholder="Password">
                              ...
                              <div class="form-group">
                              <div class="txt-centered">Forgot <a href="recover">Username / Password</a>?</div>
                              </div>
                               <button type="submit" id="submitButton" class="btn btn-danger btn-lg btn-block">Login</button>
</form>
