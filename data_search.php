...
$PostSql = $mysqli->query("SELECT * FROM business LEFT JOIN categories ON categories.cat_id=business.cid WHERE business.active=1 AND (business.business_name LIKE '%$term%' OR business.description LIKE '%$term%' OR business.tags LIKE '%$term%') ORDER BY business.biz_id DESC LIMIT $start, 12");

}else{

$PostSql = $mysqli->query("SELECT * FROM business LEFT JOIN categories ON categories.cat_id=business.cid WHERE business.active=1 AND city='$city' AND (business.business_name LIKE '%$term%' OR business.description LIKE '%$term%' OR business.tags LIKE '%$term%') ORDER BY business.biz_id DESC LIMIT $start, 12");	
