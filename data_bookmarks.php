...
if($PostSql = $mysqli->query("SELECT * FROM bookmarks LEFT JOIN business ON bookmarks.bizid=business.biz_id WHERE bookmarks.user_id=$UserId ORDER BY bookmarks.bm_id DESC LIMIT $start, 12")){
