...
<div class="page-title"><h1>Tags: <?php echo $id?></h1></div>

<?php

if($PostSql = $mysqli->query("SELECT * FROM business LEFT JOIN categories ON categories.cat_id=business.cid WHERE (tags Like '%$id%') AND business.active=1 ORDER BY business.biz_id DESC LIMIT 0, 12")){
...
<div class="col-rate">    
<span id="rate<?php echo $PostRow['biz_id'];?>"></span> <?php echo $PostRow['reviews'];?> Reviews
</div>
...
<nav id="page-nav"><a href="data_tags.php?page=2&amp;id=<?php echo $id;?>"></a></nav>
