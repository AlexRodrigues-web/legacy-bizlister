...
if($PostSql = $mysqli->query("SELECT * FROM business LEFT JOIN categories ON categories.cat_id=business.cid WHERE (tags Like '%$id%') AND business.active=1 ORDER BY business.biz_id DESC LIMIT $start, 12")){
