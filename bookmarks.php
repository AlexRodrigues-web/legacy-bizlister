...
<div class="page-title"><h1>Bookmarks</h1></div>
...
if($CountRows==0){
?>
<div class="col-note">You haven’t bookmarked any business listings. Go and add some :)</div>
<?php }?>

</div><!--container-->

<nav id="page-nav"><a href="data_bookmarks.php?page=2"></a></nav>
